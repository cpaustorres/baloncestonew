...
public class TeamResourceIntTest {
    ...
    private static final Integer DEFAULT_NSOCIOS = 1;
    private static final Integer UPDATED_NSOCIOS = 2;
    ...
    public void createTeam() throws Exception {
        ...
        assertThat(testTeam.getNsocios()).isEqualTo(DEFAULT_NSOCIOS);
    }
    ...
    public void getAllTeams() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].nsocios").value(hasItem(DEFAULT_NSOCIOS)));
    }
    ...
    public void getTeam() throws Exception {
        ...
        restTeamMockMvc.perform(get("/api/teams/{id}", team.getId()))
            ...
            .andExpect(jsonPath("$.nsocios").value(DEFAULT_NSOCIOS));
    }
    ...
    public void updateTeam() throws Exception {
        ...
        assertThat(testTeam.getNsocios()).isEqualTo(UPDATED_NSOCIOS);
    }
